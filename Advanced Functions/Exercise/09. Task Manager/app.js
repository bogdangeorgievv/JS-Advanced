function solve() {
    ...
    const [addTask, openTask, inProgress, complete] = document.querySelectorAll("section"); // продължаваме с това след като направихме функциите createArticle и newArticleTemplate
    ...
    function onSubmitHandler(e) {
        e.preventDefault() //защото страницата се презарежда със събмит и се губи информацията
